...
$lang = array_merge($lang, array(
	...
	'CUSTOMCODE_GITHUB_LINK'					=> '%1$sCustom Code Github link%2$s%3$sCustom Code%4$s extension pour phpBB',
		// CUSTOMCODE_GITHUB_LINK: Il s'agit d'un exemple de lien vers GitHub affiché en bas de la page du forum (footer) lors de l'installation de cette extension.
		// Entre %1$s et %2$s il s'agit d'un commentaire en language HTML. Entre %3$s et %4$s il s'agit du lien vers le dépot de fichier de l'extension Custom Code sur GitHub.
));
